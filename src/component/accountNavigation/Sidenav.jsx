...
const Sidenav = () => {
  ...
  return (
    <div onMouseEnter={()=>handleCollapse(false)} onMouseLeave={()=>handleCollapse(true)} className={`min-h-screen ${isCollapsed ? 'w-[60px]' :' w-[250px] rounded-r-lg' }  bg-black text-white flex flex-col`}>
