...
const Sidenav = () => {
  ...
  return (
    <div onMouseEnter={()=>handleCollapse(false)} onMouseLeave={()=>setIsCollapsed(true)} className={`min-h-screen ${isCollapsed ? 'w-[60px]' :' w-[250px] rounded-r-lg' }  bg-black text-white flex flex-col`}>
        <div className={`p-3 flex ${isCollapsed ?"flex-col justify-center": null} items-center text-2xl border-b border-gray-400`}>{isCollapsed? "C" : "Cyberizom"}</div>
