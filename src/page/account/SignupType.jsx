  ...
  return (
    <div className='h-full'>
        ...
        <div className="flex gap-5 mx-auto w-fit">
            <Link className="w-72 h-60 bg-white border-2 border-gray-300 hover:border-blue-600 ease-out duration-300 rounded flex flex-col items-center justify-center gap-1 px-5">
                <div className="rounded-full border-2 border-black p-1 text-black">
            ...
            <Link className="w-72 h-60 bg-white border-2 border-gray-300 hover:border-blue-600 ease-out duration-300 rounded flex flex-col items-center justify-center gap-1 px-5">
                ...
                <h4 className="text-lg text-blue-600 font-semibold">I am a Company</h4>
                <p className='text-center text-sm'>I want to make sure comapny security is safe by rewarding hackers who find vulnerabilities.</p>
            </Link>
        </div>
